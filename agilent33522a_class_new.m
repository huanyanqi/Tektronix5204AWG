classdef agilent33522a_class_new < handle
   ...
   % written by J Kindem 2014-2017
    ...
    properties
        ...
        datastring
        trigdata
        %rsrcname = 'USB0::0x0957::0x2307::my50002350::0::INSTR'; % fgen2 by default
        rsrcname = 'TCPIP0::A-33522A-02350::inst0::INSTR';
    end
    ...
    methods
        ...
        function setfgennumber(obj,fgennumber)
             switch fgennumber
                 case 2
                    %obj.rsrcname = 'USB0::0x0957::0x2307::my50002350::0::INSTR';
                    obj.rsrcname = 'TCPIP0::A-33522A-02350::inst0::INSTR';
                 case 4
                    %obj.rsrcname = 'USB0::0x0957::0x2307::MY50000235::0::INSTR';
                    obj.rsrcname = 'TCPIP0::A-33522A-00235::inst0::INSTR';
                 otherwise
                     error('oops! you can only select fgen 2 or 4!')
             end
         end
%         
        function open(obj)
            %obj.id = instrfind('Type', 'visa-usb', 'rsrcname',obj.rsrcname, 'Tag', '');
        ...
        function sendtrig(obj,varargin)
            switch nargin
                ...
                send(obj,sprintf('TRIG:DEL %8.8G',obj.chan,obj.trigdelay));   
                %was%8.5
        end
